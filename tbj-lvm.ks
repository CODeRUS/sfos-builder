...
part / --fstype="ext4" --size=2500 --label=root
...
droid-config-@DEVICE@-out-of-image-files
...
# Setup LVM image
dd if=/dev/zero bs=1 count=0 of=temp.img seek=4000M
...
/usr/bin/img2simg_jolla -C 1152M fimage.img
rm fimage.img
...
/usr/bin/img2simg_jolla -C 1152M sailfish.img
rm sailfish.img
